...
export declare const Bitrix: (restURI: string, accessToken?: string, clientOptions?: ExtendOptions) => {
    ...
    dealsProductRows: {
        get: (id: string) => Promise<import("../../payloads").GetPayload<import("./services/dealsProductRows/entities").Row>>;
        set: <D_1 extends {
            readonly id: string;
            readonly rows: import("./services/dealsProductRows/entities").Row[];
