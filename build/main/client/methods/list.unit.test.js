...
describe('Client `fillWithCommands` method', () => {
    it('should fill array with required amount of commands to process all entries', () => {
        ...
        expect((0, list_1.fillWithCommands)(command, start, toProcess, entriesPerCommand)).toMatchSnapshot();
    });
    ...
    it('should override `params.start`', () => {
        ...
        const commands = (0, list_1.fillWithCommands)(command, start, toProcess, entriesPerCommand);
...
describe('Client `highest` method', () => {
    it('should get highest value from object', () => {
        expect((0, list_1.highest)({ a: undefined })).toBe(undefined);
        expect((0, list_1.highest)({ a: undefined, b: undefined })).toBe(undefined);
        expect((0, list_1.highest)({ a: 1, b: undefined })).toBe(1);
        expect((0, list_1.highest)({ a: undefined, b: 1 })).toBe(1);
        expect((0, list_1.highest)({ a: 1, b: 2 })).toBe(2);
        expect((0, list_1.highest)({ a: 2, b: 1 })).toBe(2);
    });
    it('should get highest value from array', () => {
        expect((0, list_1.highest)([undefined])).toBe(undefined);
        expect((0, list_1.highest)([undefined, undefined])).toBe(undefined);
        expect((0, list_1.highest)([1, undefined])).toBe(1);
        expect((0, list_1.highest)([undefined, 1])).toBe(1);
        expect((0, list_1.highest)([1, 2])).toBe(2);
        expect((0, list_1.highest)([2, 1])).toBe(2);
    });
});
describe('Client `batchToListPayload` method', () => {
    it('should convert batch with named payloads to a list payload', () => {
        ...
        expect((0, list_1.batchToListPayload)(payload)).toMatchSnapshot();
    });
...
describe('Client `list` method', () => {
    it('should make one request when entries can be fetched in one go', async () => {
        ...
        const list = (0, list_1.default)({ call: callMock, batch: batchMock });
